...
def InceptionResNetV1(weights=None, 
                      include_top=True, 
                      classes=1000,
                      pooling=None, 
                      input_shape=None,
    ...
    x, _ = Branch(img_input, num_classes=20, is_training=True)
    ...
    if include_top:
        x = Dense(x, classes, activation=classifier_activation, name="predictions")
    
    model = tf.keras.Model(img_input, x, name='InceptionResNetV1')
    return model
